package com.yunda.lib.view.menu;
...
//        popupMenuViews.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (int) (DensityUtil.getHeightInPx(context) * 0.5)));
        popupMenuViews.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
//        popupMenuViews.setBackgroundColor(ContextCompat.getColor(context, android.R.color.transparent));
    ...
    public void closeMenu() {
        if (current_tab_position != -1) {
            ...
            popupMenuViews.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.drop_down_menu_spinner_out));
            maskView.setVisibility(View.GONE);
            maskView.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.drop_down_menu_spinner_mask_out));
            ...
            if (i == position) {
                if (current_tab_position == i) {
                    ...
                    if (current_tab_position == -1) {
                        ...
                        popupMenuViews.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.drop_down_menu_spinner_in));
                        maskView.setVisibility(VISIBLE);
                        maskView.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.drop_down_menu_spinner_mask_in));
